...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'VRA Manager'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<String> _items = ["Op", "Train"];
  final List<String> _subitems = [
    'Passing a knot while ascending',
    'Passing a knot while descending',
    'Pick-off',
  ];
  final List<String> _groups = ['Bag 1', 'Bag 2', 'Bag 3', 'Bag 4'];
  final Map<String, bool> _selectedItems = {
    'Passing a knot while ascending': false,
    'Passing a knot while descending': false,
    'Pick-off': false,
    'General rope mobility': false,
    'Edge transition': false,
    'Tripod setup': false,
    'Litter setup': false,
    'Litter mobility': false,
  };
